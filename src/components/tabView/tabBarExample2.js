	...
	render () {
		return (
			<View style={styles.tabView}>
				<ScrollableTabView
					renderTabBar={() => <ScrollableTabBar style={styles.tabBar} tabStyle={{height: 40, paddingLeft: 20, paddingRight: 20, width: 80}} />}
					...
					style={styles.tabBox}
					tabBarBackgroundColor="#ececec"											// 默认选项卡栏背景的颜色，默认为白色
				...
				>
					...
					>
						<ScrollView>
							<Text style={{height: 100}}>tab1</Text>
							<Text style={{height: 100}}>tab1</Text>
							<Text style={{height: 100}}>tab1</Text>
							<Text style={{height: 100}}>tab1</Text>
							<Text style={{height: 100}}>tab1</Text>
